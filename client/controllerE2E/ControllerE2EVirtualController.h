...
struct VirtualControllerProfile
{
	...
	/// Presentation that production classification is expected to report for
	/// this profile. Used only by assertions, never to force presentation.
	/// Valid values: "playstation", "generic"
	std::string expectedPresentation = "generic";
